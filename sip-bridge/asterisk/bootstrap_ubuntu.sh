...
required_vars=(
  ...
  MANGO_IP
  MANGO_OUT_FROM_USER
  MANGO_OUT_FROM_DOMAIN
  ELEVEN_SIP_HOST
  ELEVEN_SIP_PORT
  ELEVEN_BRIDGE_USERNAME
  ELEVEN_BRIDGE_PASSWORD
  TARGET_NUMBER_E164
  BRIDGE_EXT
  BIND_IP
  BIND_PORT
...
export PUBLIC_IP MANGO_IP MANGO_OUT_FROM_USER MANGO_OUT_FROM_DOMAIN ELEVEN_SIP_HOST ELEVEN_SIP_PORT ELEVEN_BRIDGE_USERNAME ELEVEN_BRIDGE_PASSWORD TARGET_NUMBER_E164 BRIDGE_EXT BIND_IP BIND_PORT RTP_START RTP_END
