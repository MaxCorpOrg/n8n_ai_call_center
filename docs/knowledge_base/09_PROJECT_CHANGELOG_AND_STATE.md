...
- Live prompt обновлён:
  - после первого отдельного `Здравствуйте.` агент обязан ждать ещё один короткий живой ответ;
  - запрещено склеивать `Здравствуйте.` и business-opener в одну реплику;
  - новый целевой opener:
