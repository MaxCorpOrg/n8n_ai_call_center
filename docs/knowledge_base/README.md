...
Для любой новой сессии сначала открыть:

1. `../../AGENTS.md`
2. `09_PROJECT_CHANGELOG_AND_STATE.md`
3. если задача касается email-контура:
   - `../email_followup_agent/README_RU.md`
   - `../email_followup_agent/06_CHECKPOINT_RU.md`
...
12. `../email_followup_agent/README_RU.md` — отдельный пакет документации по email-followup агенту.
...
- После изменения способа входа на прод, deploy-path или cron автодеплоя обновлять: `01`, `03`, `05`, `09`, `10`.
...
- После изменений email-followup контура обновлять: `09` и `../email_followup_agent/06_CHECKPOINT_RU.md`.
