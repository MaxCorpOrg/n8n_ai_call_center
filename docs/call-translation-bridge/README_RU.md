...
10. `10_AUTODIAL_DISPATCHER_RU.md`
   Автодозвон по таблице `Лиды_обзвон`: окно `10:00–14:00` МСК, лимит `15` живых контактов в день, не более `2` автодозвонов на номер в день и остановка кампании после исчерпания списка.
